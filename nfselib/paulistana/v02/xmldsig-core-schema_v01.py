...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/xmldsig-core-schema_v01.py')
#
# Command line arguments:
#   ./process_includes/xmldsig-core-schema_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/xmldsig-core-schema_v01.py" ./process_includes/xmldsig-core-schema_v01.xsd
#
...
class KeyValueType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, RSAKeyValue=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
class CanonicalizationMethodType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, Algorithm=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.Algorithm = _cast(None, Algorithm)
    def factory(*args_, **kwargs_):
