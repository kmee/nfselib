...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/RetornoConsultaCNPJ_v01.py')
#
# Command line arguments:
#   ./process_includes/RetornoConsultaCNPJ_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/RetornoConsultaCNPJ_v01.py" ./process_includes/RetornoConsultaCNPJ_v01.xsd
#
...
class RetornoConsultaCNPJ(GeneratedsSuper):
    ...
    estes CCM emitem NFS-e ou não."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alerta=None, Erro=None, Detalhe=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoConsultaCNPJ', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RetornoConsultaCNPJ')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RetornoConsultaCNPJ', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoConsultaCNPJ'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoConsultaCNPJ', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class DetalheType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, InscricaoMunicipal=None, EmiteNFe=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
