...
#
# Generated Wed Jul 22 06:40:29 2020 by generateDS.py version 2.30.15.
...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoConsultaNFePeriodo_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoConsultaNFePeriodo_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoConsultaNFePeriodo_v01.py" ./process_includes/PedidoConsultaNFePeriodo_v01.xsd
#
...
class PedidoConsultaNFePeriodo(GeneratedsSuper):
    """Schema utilizado para PEDIDO de consulta de NFS-e Emitidas ou
    Recebidas por período.Este Schema XML é utilizado pelos
    Prestadores/Tomadores de serviços consultarem NFS-e Emitidas ou
    Recebidas por eles."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Signature=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoConsultaNFePeriodo', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoConsultaNFePeriodo', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoConsultaNFePeriodo'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoConsultaNFePeriodo', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao='1', CPFCNPJRemetente=None, CPFCNPJ=None, Inscricao=None, dtInicio=None, dtFim=None, NumeroPagina='1', **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.CPFCNPJ is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCPFCNPJ>%s</%sCPFCNPJ>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.CPFCNPJ), input_name='CPFCNPJ')), namespaceprefix_ , eol_))
        if self.Inscricao is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricao>%s</%sInscricao>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Inscricao), input_name='Inscricao')), namespaceprefix_ , eol_))
        ...
        if self.NumeroPagina is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNumeroPagina>%s</%sNumeroPagina>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.NumeroPagina), input_name='NumeroPagina')), namespaceprefix_ , eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CPFCNPJRemetente':
            ...
            CPFCNPJ_ = child_.text
            CPFCNPJ_ = self.gds_validate_string(CPFCNPJ_, node, 'CPFCNPJ')
            self.CPFCNPJ = CPFCNPJ_
        elif nodeName_ == 'Inscricao':
            Inscricao_ = child_.text
            Inscricao_ = self.gds_validate_string(Inscricao_, node, 'Inscricao')
            self.Inscricao = Inscricao_
            ...
            NumeroPagina_ = child_.text
            NumeroPagina_ = self.gds_validate_string(NumeroPagina_, node, 'NumeroPagina')
            self.NumeroPagina = NumeroPagina_
