...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoEnvioLoteNFTS_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoEnvioLoteNFTS_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoEnvioLoteNFTS_v01.py" ./process_includes/PedidoEnvioLoteNFTS_v01.xsd
#
...
class PedidoEnvioLoteNFTS(GeneratedsSuper):
    """Schema utilizado para PEDIDO de envio de lote de NFTS.Este Schema
    XML é utilizado pelos tomadores/intermediários de serviços para
    emissão de NFTS."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, NFTS=None, Signature=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, PedidoEnvioLoteNFTS)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if PedidoEnvioLoteNFTS.subclass:
            return PedidoEnvioLoteNFTS.subclass(*args_, **kwargs_)
        else:
            return PedidoEnvioLoteNFTS(*args_, **kwargs_)
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoEnvioLoteNFTS', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('PedidoEnvioLoteNFTS')
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='PedidoEnvioLoteNFTS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoEnvioLoteNFTS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoEnvioLoteNFTS'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoEnvioLoteNFTS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for NFTS_ in self.NFTS:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNFTS>%s</%sNFTS>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(NFTS_), input_name='NFTS')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Cabecalho':
            ...
            NFTS_ = child_.text
            NFTS_ = self.gds_validate_string(NFTS_, node, 'NFTS')
            self.NFTS.append(NFTS_)
        elif nodeName_ == 'Signature':
            obj_ = SignatureType.factory(parent_object_=self)
            obj_.build(child_)
            self.Signature = obj_
            obj_.original_tagname_ = 'Signature'
# end class PedidoEnvioLoteNFTS


class CabecalhoType(GeneratedsSuper):
    """Cabeçalho do pedido NFTS.Informe a Versão do Schema XML utilizado."""
    subclass = None
    superclass = None
    def __init__(self, Versao='1', id=None, Remetente=None, transacao=True, dtInicio=None, dtFim=None, QtdNFTS=None, ValorTotalServicos=None, ValorTotalDeducoes=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.QtdNFTS = QtdNFTS
        self.validate_tpQuantidade(self.QtdNFTS)
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.QtdNFTS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sQtdNFTS>%s</%sQtdNFTS>%s' % (namespaceprefix_ , self.gds_format_integer(self.QtdNFTS, input_name='QtdNFTS'), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Remetente':
            ...
            dval_ = self.gds_parse_date(sval_)
            self.dtFim = dval_
        elif nodeName_ == 'QtdNFTS' and child_.text:
            sval_ = child_.text
            try:
                ival_ = int(sval_)
            except (TypeError, ValueError) as exp:
                raise_parse_error(child_, 'requires integer: %s' % exp)
            ival_ = self.gds_validate_integer(ival_, node, 'QtdNFTS')
            self.QtdNFTS = ival_
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'PedidoEnvioLoteNFTS'
        rootClass = PedidoEnvioLoteNFTS
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from PedidoEnvioLoteNFTS_v01 import *\n\n')
