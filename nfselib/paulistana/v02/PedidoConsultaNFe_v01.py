...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoConsultaNFe_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoConsultaNFe_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoConsultaNFe_v01.py" ./process_includes/PedidoConsultaNFe_v01.xsd
#
...
class PedidoConsultaNFe(GeneratedsSuper):
    ...
    utilizado pelos prestadores de serviços consultarem NFS-e
    geradas por eles."""
    subclass = None
    superclass = None
...
class DetalheType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, ChaveRPS=None, ChaveNFe=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DetalheType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ChaveRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sChaveRPS>%s</%sChaveRPS>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ChaveRPS), input_name='ChaveRPS')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ChaveRPS':
            ...
            ChaveRPS_ = self.gds_validate_string(ChaveRPS_, node, 'ChaveRPS')
            self.ChaveRPS = ChaveRPS_
