...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoCancelamentoLote_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoCancelamentoLote_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoCancelamentoLote_v01.py" ./process_includes/PedidoCancelamentoLote_v01.xsd
#
...
class PedidoCancelamentoLote(GeneratedsSuper):
    """Schema utilizado para PEDIDO de cancelamento de lote.Este Schema XML
    é utilizado pelos prestadores de serviços cancelarem as NFS-e
...
class CabecalhoType(GeneratedsSuper):
    """Cabeçalho do pedido de cancelamento de lote.Informe a Versão do
    Schema XML utilizado."""
    subclass = None
    superclass = None
    def __init__(self, Versao='1', CPFCNPJRemetente=None, NumeroLote=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from PedidoCancelamentoLote_v01 import *\n\n')
