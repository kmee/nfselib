...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoInformacoesLote_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoInformacoesLote_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoInformacoesLote_v01.py" ./process_includes/PedidoInformacoesLote_v01.xsd
#
...
class PedidoInformacoesLote(GeneratedsSuper):
    """Schema utilizado para PEDIDO de informações de lote.Este Schema XML
    é utilizado pelos prestadores de serviços para obterem
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoInformacoesLote', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoInformacoesLote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoInformacoesLote'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoInformacoesLote', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao='1', CPFCNPJRemetente=None, NumeroLote=None, InscricaoPrestador=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.InscricaoPrestador is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sInscricaoPrestador>%s</%sInscricaoPrestador>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.InscricaoPrestador), input_name='InscricaoPrestador')), namespaceprefix_ , eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CPFCNPJRemetente':
            ...
            InscricaoPrestador_ = child_.text
            InscricaoPrestador_ = self.gds_validate_string(InscricaoPrestador_, node, 'InscricaoPrestador')
            self.InscricaoPrestador = InscricaoPrestador_
