...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoEnvioRPS_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoEnvioRPS_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoEnvioRPS_v01.py" ./process_includes/PedidoEnvioRPS_v01.xsd
#
...
class PedidoEnvioRPS(GeneratedsSuper):
    ...
    utilizado pelos prestadores de serviços para substituição online
    e individual de RPS por NFS-e."""
    subclass = None
    superclass = None
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoEnvioRPS', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoEnvioRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoEnvioRPS'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoEnvioRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.RPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sRPS>%s</%sRPS>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.RPS), input_name='RPS')), namespaceprefix_ , eol_))
