...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/RetornoConsulta_v01.py')
#
# Command line arguments:
#   ./process_includes/RetornoConsulta_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/RetornoConsulta_v01.py" ./process_includes/RetornoConsulta_v01.xsd
#
...
class RetornoConsulta(GeneratedsSuper):
    ...
    NFS-e/RPS, consultade NFS-e recebidas e consulta de lote."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alerta=None, Erro=None, NFe=None, **kwargs_):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoConsulta', fromsubclass_=False, pretty_print=True):
        ...
        for NFe_ in self.NFe:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sNFe>%s</%sNFe>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(NFe_), input_name='NFe')), namespaceprefix_ , eol_))
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Cabecalho':
            ...
            NFe_ = child_.text
            NFe_ = self.gds_validate_string(NFe_, node, 'NFe')
            self.NFe.append(NFe_)
