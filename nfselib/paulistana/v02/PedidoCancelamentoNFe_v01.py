...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoCancelamentoNFe_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoCancelamentoNFe_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoCancelamentoNFe_v01.py" ./process_includes/PedidoCancelamentoNFe_v01.xsd
#
...
class PedidoCancelamentoNFe(GeneratedsSuper):
    """Schema utilizado para PEDIDO de Cancelamento de NFS-e.Este Schema
    XML é utilizado pelos Prestadores de serviços cancelarem NFS-e
    emitidas por eles."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Detalhe=None, Signature=None, **kwargs_):
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao='1', CPFCNPJRemetente=None, transacao=True, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
...
class DetalheType(GeneratedsSuper):
    """Detalhe do pedido de cancelamento de NFS-e. Cada detalhe deverá
    conter a Chave de uma NFS-e e sua respectiva assinatura de
    cancelamento."""
    subclass = None
    superclass = None
    def __init__(self, ChaveNFe=None, AssinaturaCancelamento=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DetalheType', fromsubclass_=False, pretty_print=True):
        ...
        if self.ChaveNFe is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sChaveNFe>%s</%sChaveNFe>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ChaveNFe), input_name='ChaveNFe')), namespaceprefix_ , eol_))
        if self.AssinaturaCancelamento is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAssinaturaCancelamento>%s</%sAssinaturaCancelamento>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.AssinaturaCancelamento), input_name='AssinaturaCancelamento')), namespaceprefix_ , eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'ChaveNFe':
            ChaveNFe_ = child_.text
            ChaveNFe_ = self.gds_validate_string(ChaveNFe_, node, 'ChaveNFe')
            self.ChaveNFe = ChaveNFe_
