...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoConsultaCNPJ_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoConsultaCNPJ_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoConsultaCNPJ_v01.py" ./process_includes/PedidoConsultaCNPJ_v01.xsd
#
...
class PedidoConsultaCNPJ(GeneratedsSuper):
    ...
    consultarem quais Inscrições Municipais (CCM) estão vinculadas a
    um determinado CNPJ e se estes CCM emitem NFS-e ou não."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, CNPJContribuinte=None, Signature=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoConsultaCNPJ', pretty_print=True):
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='PedidoConsultaCNPJ', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
    ...
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='PedidoConsultaCNPJ'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='PedidoConsultaCNPJ', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.CNPJContribuinte is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCNPJContribuinte>%s</%sCNPJContribuinte>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.CNPJContribuinte), input_name='CNPJContribuinte')), namespaceprefix_ , eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Cabecalho':
            ...
            CNPJContribuinte_ = child_.text
            CNPJContribuinte_ = self.gds_validate_string(CNPJContribuinte_, node, 'CNPJContribuinte')
            self.CNPJContribuinte = CNPJContribuinte_
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao='1', CPFCNPJRemetente=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
