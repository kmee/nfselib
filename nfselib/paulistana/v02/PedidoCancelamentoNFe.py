...
#   ('-f', '')
#   ('-o', '/home/luisotavio/Documentos/Projects/produto_12/src/nfselib/scripts/paulistanalib/v02/PedidoCancelamentoNFe.py')
#
# Command line arguments:
#   /tmp/generated/schemas/paulistana/v02/PedidoCancelamentoNFe_v01.xsd
#
# Command line:
#   /home/luisotavio/Documentos/Projects/produto_12/bin/generateDS.py --no-namespace-defs --no-dates --member-specs="list" --use-getter-setter="none" -f -o "/home/luisotavio/Documentos/Projects/produto_12/src/nfselib/scripts/paulistanalib/v02/PedidoCancelamentoNFe.py" /tmp/generated/schemas/paulistana/v02/PedidoCancelamentoNFe_v01.xsd
#
...
class DetalheType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='DetalheType', fromsubclass_=False, pretty_print=True):
        ...
        if self.AssinaturaCancelamento is not None:
            ...
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAssinaturaCancelamento>%s</%sAssinaturaCancelamento>%s' % (namespaceprefix_ , self.AssinaturaCancelamento, namespaceprefix_ , eol_))
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
