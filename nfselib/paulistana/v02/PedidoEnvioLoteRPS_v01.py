...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoEnvioLoteRPS_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoEnvioLoteRPS_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoEnvioLoteRPS_v01.py" ./process_includes/PedidoEnvioLoteRPS_v01.xsd
#
...
class PedidoEnvioLoteRPS(GeneratedsSuper):
    ...
    é utilizado pelos prestadores de serviços para substituição em
    lote de RPS por NFS-e."""
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, RPS=None, Signature=None, **kwargs_):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Cabecalho':
            ...
            RPS_ = child_.text
            RPS_ = self.gds_validate_string(RPS_, node, 'RPS')
            self.RPS.append(RPS_)
...
class CabecalhoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Versao='1', CPFCNPJRemetente=None, transacao=True, dtInicio=None, dtFim=None, QtdRPS=None, ValorTotalServicos=None, ValorTotalDeducoes=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'CPFCNPJRemetente':
            ...
            QtdRPS_ = child_.text
            QtdRPS_ = self.gds_validate_string(QtdRPS_, node, 'QtdRPS')
            self.QtdRPS = QtdRPS_
        elif nodeName_ == 'ValorTotalServicos':
            ValorTotalServicos_ = child_.text
            ValorTotalServicos_ = self.gds_validate_string(ValorTotalServicos_, node, 'ValorTotalServicos')
            self.ValorTotalServicos = ValorTotalServicos_
        elif nodeName_ == 'ValorTotalDeducoes':
            ValorTotalDeducoes_ = child_.text
            ValorTotalDeducoes_ = self.gds_validate_string(ValorTotalDeducoes_, node, 'ValorTotalDeducoes')
            self.ValorTotalDeducoes = ValorTotalDeducoes_
