...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/RetornoEnvioRPS_v01.py')
#
# Command line arguments:
#   ./process_includes/RetornoEnvioRPS_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/RetornoEnvioRPS_v01.py" ./process_includes/RetornoEnvioRPS_v01.xsd
#
...
class RetornoEnvioRPS(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, Cabecalho=None, Alerta=None, Erro=None, ChaveNFeRPS=None, **kwargs_):
    ...
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoEnvioRPS', pretty_print=True):
        ...
        self.exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='RetornoEnvioRPS')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='RetornoEnvioRPS', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='RetornoEnvioRPS'):
        pass
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='RetornoEnvioRPS', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        for Alerta_ in self.Alerta:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAlerta>%s</%sAlerta>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(Alerta_), input_name='Alerta')), namespaceprefix_ , eol_))
        for Erro_ in self.Erro:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sErro>%s</%sErro>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(Erro_), input_name='Erro')), namespaceprefix_ , eol_))
        if self.ChaveNFeRPS is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sChaveNFeRPS>%s</%sChaveNFeRPS>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.ChaveNFeRPS), input_name='ChaveNFeRPS')), namespaceprefix_ , eol_))
    def build(self, node):
        already_processed = set()
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Cabecalho':
            ...
            Alerta_ = child_.text
            Alerta_ = self.gds_validate_string(Alerta_, node, 'Alerta')
            self.Alerta.append(Alerta_)
        elif nodeName_ == 'Erro':
            Erro_ = child_.text
            Erro_ = self.gds_validate_string(Erro_, node, 'Erro')
            self.Erro.append(Erro_)
        elif nodeName_ == 'ChaveNFeRPS':
            ChaveNFeRPS_ = child_.text
            ChaveNFeRPS_ = self.gds_validate_string(ChaveNFeRPS_, node, 'ChaveNFeRPS')
            self.ChaveNFeRPS = ChaveNFeRPS_
...
class CabecalhoType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='CabecalhoType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Sucesso is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sSucesso>%s</%sSucesso>%s' % (namespaceprefix_ , self.gds_encode(self.gds_format_string(quote_xml(self.Sucesso), input_name='Sucesso')), namespaceprefix_ , eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'Sucesso':
            Sucesso_ = child_.text
            Sucesso_ = self.gds_validate_string(Sucesso_, node, 'Sucesso')
            self.Sucesso = Sucesso_
