...
#   ('-f', '')
#   ('-o', './paulistanalib/v02/PedidoConsultaLote_v01.py')
#
# Command line arguments:
#   ./process_includes/PedidoConsultaLote_v01.xsd
#
# Command line:
#   /home/mileo/Projects/oca12/bin/erpbrasil-edoc-gen-generate-python --no-namespace-defs --no-collect-includes --use-getter-setter="none" -f -o "./paulistanalib/v02/PedidoConsultaLote_v01.py" ./process_includes/PedidoConsultaLote_v01.xsd
#
...
class PedidoConsultaLote(GeneratedsSuper):
    ...
    utilizado pelos prestadores de serviços consultarem as NFS-e
