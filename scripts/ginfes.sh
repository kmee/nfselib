...
erpbrasil-edoc-gen-generate-python -m nfse -n ginfes -v v3.01 -i "servico_enviar_lote_rps_resposta_v03|servico_consultar_situacao_lote_rps_resposta_v03|servico_consultar_lote_rps_resposta_v03|servico_enviar_lote_rps_envio_v03" -d .
